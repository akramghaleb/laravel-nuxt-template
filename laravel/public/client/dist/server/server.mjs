...
const components_plugin_lvtCW5DHEm = /* @__PURE__ */ defineNuxtPlugin({
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-gwbwwDv3.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-e9gWVFny.js").then((r) => r.default || r));
